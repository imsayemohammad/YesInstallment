<%@ Page Title="Customer Wise Transaction Report" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Accounts_Transactions.aspx.cs" Inherits="Yesbd.Report.UI.Accounts_Transactions" %>
    ...
    <div class="col-md-12" id="mainContentBox">
        <div id="contentBox" style="display: block">
            <div id="contentHeaderBox">
                <h1>Customer Wise Transaction</h1>
            ...
            <div class="form-class">
                ...
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtClientNM" TabIndex="1" AutoPostBack="True" CssClass="form-control input-sm" runat="server" OnTextChanged="txtClientNM_TextChanged"></asp:TextBox>
                        <asp:AutoCompleteExtender ID="txtClientNM_AutoCompleteExtender" runat="server"
                            ...
                            ServicePath="Accounts_Transactions.aspx" TargetControlID="txtClientNM" UseContextKey="True">
                        </asp:AutoCompleteExtender>
                        <%--<asp:DropDownList ID="ddlClientNM" runat="server" AutoPostBack="True" CssClass="form-control input-sm"
                            OnSelectedIndexChanged="ddlClientNM_SelectedIndexChanged" TabIndex="1">
                        </asp:DropDownList>--%>
                    </div>
                    <div class="col-md-2"></div>
                </div>
